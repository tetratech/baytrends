...
```{r}
library(pkg.fun.bt)
pkg.fun.bt <- ls("package:baytrends033")
...
# New from smwrBase
example("baseDay", package="baytrends033") #02/17
example("baseDay2decimal", package="baytrends033") #03/17
...
Load smwrQW then open dataCensored.  Works and defaults to first namespace (baytrends033).  Then resave.
