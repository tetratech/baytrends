...
Information about the settings for dvAvgWinSel, dvAvgWgtSel, dvAvgSidesSel, and lowess.f are described in the help file for this function.  
...
# Save list to data file separate use
save(flow.salinity, file='mySeasonallyDetrendedSalinity.rda')
```
...
# Run Function
detrended.salinity(df.sal, dvAvgWinSel, lowess.f, minObs, minObs.sd) 
```
