...
===========
* Release 2021-05-12
* Updated layer aggregration to use dplyr::bind_rows to combine data frames with Surv objects.
* Updated default gamDiffPeriods to 1999-2001 and 2011-2013
* Updated calculation of fraction of observations that are censored
* Updated layer aggregation to allow for computing medians in addition to mean
