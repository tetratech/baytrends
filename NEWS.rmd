...
===========
* Change default number of years used in computing differences from 2 years to 3 years. New parameter analySpec$gamDiffNumChgYrs set to 3 years, but can be set back to 2 years (or any number of years based on user input).
