...
baytrends 2.0.5.9008
===========
* Release 2021-07-02
* docs: qc'ed parameter definitions in function documentation
    + gamMeanCI
    + loadData
    + loadExcel

baytrends 2.0.5.9007
===========
* Release 2021-07-02
* refactor: Update gamMeanCI with package prefixes, Issue #69
* refactor: Remove . from piped dplyr statements in gamMeanCI
* docs: Add missing parameters to function documentation
    + gamMeanCI
    + loadData
    + loadExcel

baytrends 2.0.5.9006
===========
* Release 2021-06-25
* refactor: Additional gamMeanCI updates

baytrends 2.0.5.9005
===========
* Release 
* gamDiffPlot updated to correct where baseline and current means are plotted

baytrends 2.0.5.9004
===========
* Release 
* loadData and loadExcel updated to allow table suppression (needs qc)

baytrends 2.0.5.9003
===========
* Release
* gamMeanCI function beta version (needs qc)

baytrends 2.0.5.9002
===========
* Release
* gamMeanCI function added to calculate mean CI (needs substantial clean up)

baytrends 2.0.5.9001
===========
* Release 
* update function createResiduals to return fitted values
...
===========
* Release 2021-05-12
* fix: Updated layer aggregration to use dplyr::bind_rows to combine data frames
with Surv objects
* refactor: Updated default gamDiffPeriods to 1999-2001 and 2011-2013
* refactor: Updated calculation of fraction of observations that are censored
* refactor: Updated layer aggregation to allow for computing medians in addition
to mean
...
===========
* Release 2021-04-15
* Change default number of years used in computing differences from 2 years to 
3 years. New parameter analySpec$gamDiffNumChgYrs set to 3 years, but can be set
back to 2 years (or any number of years based on user input).
...
* Import nobs from gdata as a new function.
    + gdata in danger of being archived.  No meaningful response from maintainer after 6 weeks.
...
* Update example in unSurv and unSurvDF to match example in makeSurvDF; Issue #50

baytrends 1.2.1.8015
===========
* Release 2020-07-20
* Allow user values for column names / suffixes in unSurv and unSurvDF; Issue #50
...
===========
* Release 2020-05-22
* updated gamTest (and related support functions) to run using Surv fields

baytrends 1.2.1.8001
===========
* Release 2020-03-31
* migrated demonstration data set, dataCensored, from qw to Surv fields for censored data
...
===========
* Release 2020-03-20
* Rebuild package after merging with dev02 branch to ensure all documentation is copacetic.
...
===========
* Release 2020-01-28
* Add missing functions from smwrGraphs so all examples will run without any errors.
...
===========
* Release 2019-12-21
* Function createResiduals modified to return data frame, df, rather than just a vector
...
* DESCRIPTION
    ...
    + Change 'additional repositories' to GitHub.  Was https://owi.usgs.gov/R.
* .Rbuildignore
...
* Corrected getUSGSflow function to accommodate missing values at beginning/ending of record
...
* Add functions from swmr packages:
