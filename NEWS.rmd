...
===========
* corrected passing of default seasonally detrended files
...
===========
* Release 2018-05-07
* Added salinity.detrended as a variable to three functions to pass Check (no visible binding for global variable):
    + .gamPlotCalc
    + .mergeSalinity
    + gamDiff
...
===========
* Release 2018-05-07
* Repackage with revised NEWS, NAMESPACE, and DESCRIPTION.
* Ensure all Development branch modifications were merged.
* Re-run Check.
    + Move package `plyr` from Suggests to Imports in DESCRIPTION
